        ...
        <div className='timing-section'>
            ...
            <div className='timing-container'>
                <TimingPoint time={'10:00'}
                             text={'Хотим начать наше мероприятие с традиционного выкупа невесты! Проходить он будет в доме невесты (ж/д станция Калейкино, ул.Гагарина, д.1)'}
                             header={'Выкуп'}/>
                ...
                <TimingPoint time={'16:00'}
                             text={'Приглашаем наших гостей на фуршет, где Вас будут ждать разные интерактивы и легкие закуски! \n' +
                                 'Набережные Челны, поселок Орловка, Орловская ул., 209'}
                             header={'Welcome'}/>
                <TimingPoint time={'16:30'}
